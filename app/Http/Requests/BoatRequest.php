...
class BoatRequest extends FormRequest
{
    ...
    /**
     * @return array{name: string, sponsor: ?string, hull_color: ?string, length_m: ?string, notes: ?string, is_active: bool}
     */
    public function boatData(): array
    {
        return [
            ...$this->safe()->only(['name', 'sponsor', 'hull_color', 'length_m', 'notes']),
